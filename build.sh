...
echo "Generating VFs"
# mkdir -p ./fonts/variable
fontmake -g source/Mohave.glyphs -o variable --round-instances --output-path ./fonts/vf/Mohave\[wght\].ttf
fontmake -g source/Mohave-Italic.glyphs -o variable --round-instances --output-path ./fonts/vf/Mohave-Italic\[wght\].ttf
