...
* ⚠ **WARN** The file "./static/Mohave-Light.ttf" is a font binary in a subdirectory.
...
* ⚠ **WARN** The file "./static/Mohave-MediumItalic.ttf" is a font binary in a subdirectory.
Please keep all font files directly on the root directory side-by-side with its corresponding METADATA.pb file. [code: font-on-subdir]
* ⚠ **WARN** The file "./static/Mohave-Italic.ttf" is a font binary in a subdirectory.
Please keep all font files directly on the root directory side-by-side with its corresponding METADATA.pb file. [code: font-on-subdir]
* ⚠ **WARN** The file "./static/Mohave-Medium.ttf" is a font binary in a subdirectory.
Please keep all font files directly on the root directory side-by-side with its corresponding METADATA.pb file. [code: font-on-subdir]
* ⚠ **WARN** The file "./static/Mohave-BoldItalic.ttf" is a font binary in a subdirectory.
Please keep all font files directly on the root directory side-by-side with its corresponding METADATA.pb file. [code: font-on-subdir]
* ⚠ **WARN** The file "./static/Mohave-LightItalic.ttf" is a font binary in a subdirectory.
Please keep all font files directly on the root directory side-by-side with its corresponding METADATA.pb file. [code: font-on-subdir]
* ⚠ **WARN** The file "./static/Mohave-Regular.ttf" is a font binary in a subdirectory.
Please keep all font files directly on the root directory side-by-side with its corresponding METADATA.pb file. [code: font-on-subdir]
* ⚠ **WARN** The file "./static/Mohave-Bold.ttf" is a font binary in a subdirectory.
Please keep all font files directly on the root directory side-by-side with its corresponding METADATA.pb file. [code: font-on-subdir]
...
<details>
<summary><b>[134] Mohave-Italic[wght].ttf</b></summary>
<details>
...
* ℹ **INFO** Found a git repo URL: https://github.com/bghryct/Mohave-Typefaces [code: url-found]
* 🍞 **PASS** Looks great!
...
|  | Mohave-Italic[wght].ttf |
|:--- | ---:|
| Dehinted Size | 66.3kb |
| Hinted Size | 65.9kb |
| Increase | -396 bytes |
| Change   | -0.6 % |
 [code: size-impact]
...
* 🍞 **PASS** Mohave-Italic[wght].ttf is named canonically.
...
* 🍞 **PASS** Family name "Mohave" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** Postscript name "Mohave-LightItalic" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** Font fullname "Mohave Light Italic" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** Name Table entry: Copyright field 'Copyright 2019 The Mohave Project Authors (https://github.com/bghryct/Mohave-Typefaces)' matches canonical pattern.
...
<details>
<summary><b>[134] Mohave[wght].ttf</b></summary>
<details>
<summary>⚠ <b>WARN:</b> METADATA.pb: Fontfamily is listed on Google Fonts API?</summary>
...
* 🍞 **PASS** Mohave[wght].ttf is named canonically.
...
* 🍞 **PASS** Postscript name "Mohave-Light" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** Font fullname "Mohave Light" is identical in METADATA.pb and on the TTF file.
